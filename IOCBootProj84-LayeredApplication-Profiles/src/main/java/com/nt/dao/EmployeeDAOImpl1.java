...
public  class EmployeeDAOImpl1 implements EmployeeDAO {
	private static final String INSERT_EMP_QUERY="INSERT INTO SPRING_LAYERED_EMPLOYEE(EMPNAME,EMPADDRS,BASICSALARY,GROSSSALARY,NETSALARY) VALUES(?,?,?,?,?)";
	@Autowired
	...
	public int insert(EmployeeBO bo) throws Exception {
		System.out.println("EmployeeDAOImpl.insert() ::: ds-->"+ds.getClass()+" for DEV,TEST");
		Connection con=null;
